...
parser.add_argument('--rand_k', type=int, default=20,
                help='randomly select k captions from all generated captions for consensus reranking, \
                      20 or 100')
parser.add_argument('--caption_file', type=str, default='predictions_60000_nms_55_beam-1.npy',
...
parser.add_argument('--input_file', type=str, default='splitted_predictions_60000_nms_55_beam-1_top_4.npy',
                help='input file name, the input file contains the splitted tokens of captions')
...
subgraph_sents = np.load(sentence_path + '/' + caption_file,allow_pickle=True).tolist()
split_sents = []
...
args.input_file = converted_file
