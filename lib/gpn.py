...
class gpn_layer(nn.Module):
    def __init__(self, GCN_dim=1024, hid_dim=512, test_LSTM=False, use_nms=True, iou_thres=0.75, max_subgraphs=1):
        ...
        self.use_sGPN_score = True  # True, use sGPN network and sGPN loss; if False, SCT training and testing, use gt sub-graphs 
